...
<tr>
	...
	<td width="250" align="left"><input type="text" name="" value="De Acuerdo" size="50" /></td>
</tr>
<tr>
	<td width="150" align="left">Posición</td>
	<td width="250" align="left">
		<select name="">
			<option value="">Seleccione una Posición</option>
			<option value="" selected="selected">Columna</option>

...
<!--
	function fillOpenerRow(){
		...
		if (window.opener && !window.opener.closed){
			...
			updateCheckBoxListQuestionToSession(name, image, questionTxt, row);
...
function editRow(rowNum){
	currentRow = rowNum;
	popModal('popUp/AnswerUpdate01.jsp','AnswerUpNew11',150,420,0)
}
...
// AJAX Functions
	...
	function updateCheckBoxListQuestionToSession(name, image, questionTxt, row){
      ...
      // Third parameter specifies request is asynchronous.
      req.open("POST", "survey.do?method=updateCheckBoxListQuestionInSection", false);
...
<tr>
	...
	<td width="400" align="left">Múltiple</td>
</tr>
<tr>
